        ...
        <div  className='container'>
            ...
            className='grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl'>
                ...
                <div className='p-6 sm:p-8'>
                    ...
                    <p data-aos="fade-up" className='text-sm'>{data.data}</p>
                </div>
                {/* second col */}
                <div data-aos="zoom-in" className='h-full flex items-center '>
                    <img src={data.image} alt="" className='scale-122 w-250px md:w-340px mx-auto drop-shadow-2xl object-cover'/>
                </div>
                {/* third col */}
                <div className='flex flex-col justify-center gap-4 p-6 sm:p-8'>
                    ...
                    <div data-aos="fade-up" data-oas-offset= "0" > 
                        <button  style={{color: data.bgColor}}
                         className='bg-white py-2 px-4 rounded-full text-primary'>Shop Now</button>
                    </div>
                </div>
            </div>
        </div>
