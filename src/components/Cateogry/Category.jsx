            ...
            <div className='container'>
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
                    ...
                    h-80 flex items-end'>
                        ...
                        <img src={Image1} alt=""
                        className='w-320 h-500 absolute bottom-0 '      
                        />
                    </div>
                    ...
                    h-80 flex items-end'>
                        ...
                        <img src={Image2} alt=""
                        className='w-320  h-500 absolute left-20 top-7 lg:top-45'      
                        />
                    </div>

                    {/* Third col */}
                    <div className=' sm:col-span-2 py-10 pl-5 bg-gradient-to-br from-primary to-primary/90 text-white rounded-3xl relative
                    h-80 flex items-end'>
                        <div>
                        <div className='mb-4 '>
                        ...
                        <img src={Image3} alt=""
                        className='w-250 h-30 absolute top-1/2 -translate-y-1/2  -right-10 '      
                        />
                    </div>
                </div>
            </div>
