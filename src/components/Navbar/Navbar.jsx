    ...
    <div className='bg-white dark:bg-gray-900 dark:text-white duration-200 relative z-40'>
        ...
        <div className="container flex justify-between items-center">
            ...
            <div className='flex items-center gap-4'>
                <a href="#" 
                className='text-primary font-semibold tracking-widest text-2xl uppercase sm:text-3xl'>E-shop</a>
                {/* Menu Items */}
                <div className='hidden lg:block'>
                    <ul className='flex items-center gap-4 '>
                        {
                        MenuLinks.map((data, index) => (
                            <li key={index}><a href={data.link} className='inline-block px-4 font-semibold text-gray-500 hover:text-black dark:hover:text-white duration-200'> {data.name}</a></li>
                        ))}
                            {/* Dropdowm */}
                        <li className='relative cursor-pointer group'>
                            <a href="#" className='flex items-center gap-2px font-semibold text-gray-500 dark:hover:text-white py-2'>Quick Links
                            <span><FaCaretDown  className='group-hover:rotate-180 duration-300 '/></span></a>
            ...
            <div className='flex justify-between items-center gap-4'>
                ...
                <div className='relative group hidden sm:block '>
                    ...
                    <FaSearch  className='text-xl text-gray-600 group-hover:text-primary dark:text-gray-400 absolute top-1 translate-y-1 right-3 
                    duration-200 ' />
                </div>
                {/* Cart Section */}
